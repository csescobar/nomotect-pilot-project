...
- `test:Services::Distributions::Manifest` —TESTED_BY→ `test:Services::OperationalReadiness::BackupManifest`
- `test:Services::Extensions::Manifest` —TESTED_BY→ `test:Services::OperationalReadiness::BackupManifest`
- `controller:Health` —TESTED_BY→ `test:Services::OperationalReadiness::OperationalHealthInspector`
- `test:Services::Distributions::Inspector` —TESTED_BY→ `test:Services::OperationalReadiness::OperationalHealthInspector`
- `test:Services::Extensions::Inspector` —TESTED_BY→ `test:Services::OperationalReadiness::OperationalHealthInspector`
